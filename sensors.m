...
%    wd      = uu(24);
    ...
    % simulate rate gyros (units are rad/sec) Eqn 7.5
    y_gyro_x = p + P.sigma_gyro*randn;
    y_gyro_y = q + P.sigma_gyro*randn;
    y_gyro_z = r + P.sigma_gyro*randn;

    % simulate accelerometers (units of g) Eqn 7.3
    ...
    y_static_pres = P.rho*P.gravity*(-pd) + P.beta_abs_press + P.sigma_abs_press*randn; % Eqn 7.9
    y_diff_pres = ((P.rho*Va^2)/2) + P.beta_diff_press + P.sigma_diff_press*randn; % Eqn 7.10
